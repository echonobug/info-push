...
//        message.setFrom(from);
    ...
    public void sendMime(String subject, String text, String... to) throws MessagingException {
        ...
        File file = new File("src\\main\\resources\\static\\img\\test.jpg");
        mimeMessageHelper.addInline("test.jpg", file);
